...
[
  ...
  //bu ordersları her açıdan çok iyi çekebildiğimizde data olayını iyi anlamışız demektir.

  // ---ÖDEV---
// -Ürünleri pahalıdan ucuza sırala(sort metodu kullanarak ve kullanmadan)
// -En pahalı ürün? sort metodu kullanarak yaz

// -Brezilyadan kaç adet sipariş aldım
var brazilOrders = orders.filter(q => q.shipAddress?.country == 'Brazil');

//console.log('Brazil orders count', brazilOrders.length);

// -Brezilyadan aldığın siparişlerin toplam tutarı
...
brazilOrders.forEach(function (item) {
  ...
  item.totalPrice = orderPrice //burdan aslında kendimiz bir satır ekleyerek sipariş toplamlarını ghör
  totalPrice = totalPrice + orderPrice
