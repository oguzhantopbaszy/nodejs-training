...
//Find metodu
//Find metodu bir dizi içerisinden belirtilen koşul veya koşullara uygun objeyi bana verir.
//Filter ise bize bir dizi olarak istediklerimizi verir.
...
console.log(findProduct);*/ //bu uzun yoldu

var findProduct = products.find(q => q.id == 13)
var findProduct2 = products.find(q => q.categoryId == 2)

//Ürün fiyatı 30'dan büyük olanları yazdır

//var filteredProduct = products.find(q => q.unitPrice > 30) //find ile yazınca birini bulup aramayı bırakır
var filteredProduct = products.filter(q => q.unitPrice > 30) //fakat filter ile yazınca bütün ürünleri gezerek buldukça yazdırır.

//Ürün fiyatı 30'dan büyük olan kaç adet ürünün var

var filteredProductCount = filteredProduct.length;
// console.log(filteredProductCount)

var filteredProduct2 = products.filter(q => q.unitPrice > 30 && q.categoryId == 2);
//console.log('filteredProducts', filteredProduct2);
...
//2. güne de bunun üzerinden devam etti.

//bu dizide kaç eleman var? yani kaç ürün var ?
//var productsCount = products.length //eleman sayısını bize kısa yoldan verir. aşağısındaki uzun yol
...
//console.log('Count', productsCount); // log yazınca yanında çıkan altı çizili kare sembolü kısaltma olduğu anlamına geliyor.
...
//console.log(products); böyle vermiyor gibi tekrar bak!!!!!!!!

//discontinued false olan kaç ürün var??

var filterProductsbyDiscontinued = products.filter(x => x.discontinued == false)
//console.log('filteredCount', filterProductsbyDiscontinued.length);

//Küçükten büyüğe sıralama productsları
